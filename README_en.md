...
Tool batches A/B/C, the six-call budget, redacted live tool activity, mixed responses, provider streaming, and TTY Markdown rendering are implemented, while Foundation 5A remains deferred. Current versions are canonical system prompt v17, provider adapter contract v19, ToolArguments v1, ActionIdentity v1, `turn_committed` schema v3, Action Audit schema v1, `context_compacted` v2/v3 replay, and `ctx-v1`/`ctx-v2` representations; the empty full-context identity is `ctx-v1-4bcd666498bd96b3af1aa59a1d6793b31cdcdcff1dc274db80c6f051f1e8b6da`. Work that exceeds the budget must be staged within six sequential calls and report what remains instead of packing multiple tool calls. Recursive copying/deletion, ignore-aware or indexed search, fuzzy/free-form patching, directory movement, non-empty deletion, recursive mkdir, shell source strings, interactive PTYs, network tools, automatic retry/fallback, parallel tools, multiple agents, and remote services remain unavailable. See [ADRs 0037](./docs/decisions/0037-batch-a-bounded-workspace-navigation.md), [0038](./docs/decisions/0038-batch-b-process-isolated-regex-grep.md), and [0039](./docs/decisions/0039-batch-c-structured-exact-multi-edit-patch.md) for the tool batches, [ADR 0040](./docs/decisions/0040-shared-six-call-tool-budget.md) for the six-call budget, [ADR 0054](./docs/decisions/0054-sequential-tool-call-budget-hardening.md) for sequential budget hardening, [ADR 0041](./docs/decisions/0041-live-redacted-tool-activity-events.md) for live activity, [ADRs 0042](./docs/decisions/0042-provider-neutral-assistant-tool-text-representation.md) through [0046](./docs/decisions/0046-agent-loop-and-terminal-assistant-tool-text-integration.md) for mixed responses, [ADRs 0047](./docs/decisions/0047-provider-neutral-synchronous-response-streaming.md) through [0050](./docs/decisions/0050-agentloop-runtime-and-terminal-streaming-integration.md) for streaming, and [ADR 0051](./docs/decisions/0051-tty-markdown-rendering.md) for Markdown rendering.
