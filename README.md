...
| `/session list [count] [open\|closed] [active\|archived] [model=<名称>] [name=<文本>]` | 按状态、归档标记、精确model和名称字面子串组合筛选workspace Session |
