...
from leonervis_code.skills.authoring import SkillImportResult, import_skill
...
class SkillCandidateStore:
    ...
    def __init__(
        ...
        *,
        ...
        self.root = self.workspace / ".leonervis-code" / "skill-candidates" / "v1"
...
def _remote_candidate_id(
    ...
    return "skc-v1-" + hashlib.sha256(b"leonervis-remote-skill-v1\0" + payload).hexdigest()
