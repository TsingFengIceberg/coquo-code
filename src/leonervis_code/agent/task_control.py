...
from leonervis_code.task_records import canonical_plan_id, canonical_stage_id, canonical_task_id
...
class TaskLifecycleRequest:
    ...
    def request_sha256(self) -> str:
        ...
        return hashlib.sha256(b"leonervis-task-lifecycle-request-v1\0" + payload).hexdigest()
