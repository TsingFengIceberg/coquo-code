...
from coquo.mcp.catalog import McpCandidateDisposition, McpToolCandidate
...
from coquo.mcp.config import McpServerEntry, McpServerStore
...
def _session_matches_candidate(session: McpRuntimeSession, candidate: McpToolCandidate) -> bool:
    ...
    for tool in session.tools:
        if tool.name == candidate.remote_name:
            from coquo.mcp.catalog import mcp_schema_fingerprint
