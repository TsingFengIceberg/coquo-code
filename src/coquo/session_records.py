"""Closed versioned records for durable Coquo sessions.

This module owns only the typed transcript format and replay invariants. Filesystem
safety, locking, and durability live in :mod:`coquo.session_store`.
"""
...
from coquo.core.actions import ActionIdentity, canonical_uuid4
...
def workspace_fingerprint(workspace: Path) -> str:
    ...
    digest = hashlib.sha256(b"coquo-workspace-v1\0" + canonical).hexdigest()
