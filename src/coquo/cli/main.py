...
from coquo.cli.approval import (
...
from coquo.hook_runner import HookRunner
from coquo.core.hook_contracts import HookHandlerSpec
...
from coquo.mcp.config import parse_environment_bindings
from coquo.evals import (
    EvalError,
    builtin_eval_cases,
...
from coquo.providers.model_context import ModelContextCapabilityResolver
...
from coquo.providers.request_context import ContextPreflightError
...
from coquo.tools.mkdir import MkdirTool
from coquo.tools.move_file import MoveFileTool
from coquo.tools.copy_file import CopyFileTool
from coquo.tools.read_file import ReadFileTool
from coquo.tools.run_command import RunCommandTool
from coquo.tools.edit_file import EditFileTool
from coquo.tools.write_file import WriteFileTool
from coquo.tools.web_search import WebSearchTool
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="coquo",
        description="Coquo: a learning-first local coding-agent CLI prototype.",
    )
    ...
    *,
    ...
    if arguments.eval_command == "task":
        ...
        if arguments.output is not None:
            ...
            return exit_code
        with TemporaryDirectory(prefix="coquo-coding-task-") as temporary:
