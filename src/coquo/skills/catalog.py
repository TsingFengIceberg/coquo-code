...
_FINGERPRINT_DOMAIN = b"coquo-skill-v1\0"
_INVENTORY_DOMAIN = b"coquo-skill-inventory-v2\0"
_RESOURCE_DOMAIN = b"coquo-skill-resource-v1\0"
...
class SkillInventoryLoader:
    ...
    def __init__(self, workspace: Path, environment: Mapping[str, str] | None = None) -> None:
        ...
        self._roots = (
            (SkillSourceKind.WORKSPACE_LOCAL, self._workspace / ".coquo" / "skills"),
            (SkillSourceKind.PROJECT_SHARED, self._workspace / ".agents" / "skills"),
            (SkillSourceKind.USER, config_home / "coquo" / "skills"),
        )
