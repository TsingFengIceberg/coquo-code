...
_TOOL_CONTRACT_ID_DOMAIN = b"coquo-extension-tool-contract-v1\0"
_TOOL_REGISTRY_ID_DOMAIN = b"coquo-tool-registry-snapshot-v1\0"
_TOOL_SET_ID_DOMAIN = b"coquo-tool-set-snapshot-v1\0"
